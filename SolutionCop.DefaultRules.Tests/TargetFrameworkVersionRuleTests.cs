...
namespace SolutionCop.DefaultRules.Tests
{
    ...
    public class TargetFrameworkVersionRuleTests
    {
        ...
        public void Should_fail_for_invalid_target_version()
        {
            ...
            Approvals.VerifyAll(_instance.ValidateProject(new FileInfo(@"..\..\Data\TargetFrameworkVersion\TargetFramework3_5.csproj").FullName, XElement.Parse(config)), "Errors");
        }
