...
namespace SolutionCop.DefaultRules.Tests
{
    ...
    public class TargetFrameworkVersionRuleTests
    {
        ...
        public void Should_accept_correct_target_version()
        {
            ...
            var errors = _instance.ValidateProject(new FileInfo(@"..\..\Data\TargetFramework3_5.csproj").FullName, XElement.Parse(config));
            Assert.Empty(errors);
        }
        ...
        public void Should_fail_for_invalid_target_version()
        {
            ...
            Approvals.VerifyAll(_instance.ValidateProject(new FileInfo(@"..\..\Data\TargetFramework3_5.csproj").FullName, XElement.Parse(config)), "Errors");
        }
